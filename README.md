# @f1stnpm2/veritatis-neque-pariatur
...
1. Supported Node.js versions vary by release, please consult the [releases page](https://github.com/f1stnpm2/veritatis-neque-pariatur/releases).
1. Node versions that hit end of life <https://github.com/nodejs/Release>, will be dropped from support at each @f1stnpm2/veritatis-neque-pariatur release (major, minor).
...
Below is a quick guide for minimum and maximum supported versions of @f1stnpm2/veritatis-neque-pariatur:

NodeJS  | Supported @f1stnpm2/veritatis-neque-pariatur version | Node Module
--------|-----------------------------|------------
Node 20 | 9.0+                        | 115
Node 19 | 8.0+                        | 111
Node 18 | 8.0+                        | 108
...
<table>
  <tr>
    <td>
      <img width="77px" alt="Sass logo" src="https://rawgit.com/sass/@f1stnpm2/veritatis-neque-pariatur/master/media/logo.svg" />
    </td>
    <td valign="bottom" align="right">
      <a href="https://www.npmjs.com/package/@f1stnpm2/veritatis-neque-pariatur">
        <img width="100%" src="https://nodei.co/npm/@f1stnpm2/veritatis-neque-pariatur.png?downloads=true&downloadRank=true&stars=true">
      </a>
    </td>
  </tr>
</table>

![Alpine](https://github.com/f1stnpm2/veritatis-neque-pariatur/workflows/Build%20bindings%20for%20Alpine%20releases/badge.svg)
![Linux](https://github.com/f1stnpm2/veritatis-neque-pariatur/workflows/Build%20bindings%20for%20Linux%20releases/badge.svg)
![macOS](https://github.com/f1stnpm2/veritatis-neque-pariatur/workflows/Build%20bindings%20for%20macOS%20releases/badge.svg)
![Windows x64](https://github.com/f1stnpm2/veritatis-neque-pariatur/workflows/Build%20bindings%20for%20Windows%20releases/badge.svg)
![Linting](https://github.com/f1stnpm2/veritatis-neque-pariatur/workflows/Lint%20JS/badge.svg)
[![Windows x86](https://ci.appveyor.com/api/projects/status/22mjbk59kvd55m9y/branch/master?svg=true)](https://ci.appveyor.com/project/sass/@f1stnpm2/veritatis-neque-pariatur/branch/master)
[![Coverage Status](https://coveralls.io/repos/sass/@f1stnpm2/veritatis-neque-pariatur/badge.svg?branch=master)](https://coveralls.io/r/sass/@f1stnpm2/veritatis-neque-pariatur?branch=master)

Node-sass is a library that provides binding for Node.js to [LibSass], the C version of the popular stylesheet preprocessor, Sass.

It allows you to natively compile .scss files to css at incredible speed and automatically via a connect middleware.

Find it on npm: <https://www.npmjs.com/package/@f1stnpm2/veritatis-neque-pariatur>
...
```shell
npm install @f1stnpm2/veritatis-neque-pariatur
```
...
Are you seeing the following error? Check out our [Troubleshooting guide](https://github.com/f1stnpm2/veritatis-neque-pariatur/blob/master/TROUBLESHOOTING.md#installing-@f1stnpm2/veritatis-neque-pariatur-4x-with-node--4).**

```
SyntaxError: Use of const in strict mode.
```

**Having installation troubles? Check out our [Troubleshooting guide](https://github.com/f1stnpm2/veritatis-neque-pariatur/blob/master/TROUBLESHOOTING.md).**
...
```javascript
var sass = require('@f1stnpm2/veritatis-neque-pariatur');
sass.render({
  file: scss_filename,
  [, options..]
}, function(err, result) { /*...*/ });
...
```javascript
var Color = require('@f1stnpm2/veritatis-neque-pariatur').types.Color,
...
__Note:__ @f1stnpm2/veritatis-neque-pariatur/libsass will compile a mixed library of scss and indented syntax (.sass) files with the Default setting (false) as long as .sass and .scss extensions are used in filenames.
...
* In the case that both `file` and `data` options are set, @f1stnpm2/veritatis-neque-pariatur will give precedence to `data` and use `file` to calculate paths in sourcemaps.

### Version information (>= v2.0.0)

Both `@f1stnpm2/veritatis-neque-pariatur` and `libsass` version info is now exposed via the `info` method:
...
/*
  ...
  @f1stnpm2/veritatis-neque-pariatur       2.0.1   (Wrapper)       [JavaScript]
  libsass         3.1.0   (Sass Compiler) [C/C++]
*/
```

Since @f1stnpm2/veritatis-neque-pariatur >=v3.0.0 LibSass version is determined at run time.

## Integrations

Listing of community uses of @f1stnpm2/veritatis-neque-pariatur in build tools and frameworks.

### Brackets extension

[@jasonsanjose](https://github.com/jasonsanjose) has created a [Brackets](http://brackets.io) extension based on @f1stnpm2/veritatis-neque-pariatur: <https://github.com/jasonsanjose/brackets-sass>. When editing Sass files, the extension compiles changes on save. The extension also integrates with Live Preview to show Sass changes in the browser without saving or compiling.

### Brunch plugin

[Brunch](http://brunch.io)'s official sass plugin uses @f1stnpm2/veritatis-neque-pariatur by default, and automatically falls back to ruby if use of Compass is detected: <https://github.com/brunch/sass-brunch>

### Connect/Express middleware

Recompile `.scss` files automatically for connect and express based http servers.

This functionality has been moved to [`@f1stnpm2/veritatis-neque-pariatur-middleware`](https://github.com/f1stnpm2/veritatis-neque-pariatur-middleware) in @f1stnpm2/veritatis-neque-pariatur v1.0.0

### DocPad Plugin

[@10xLaCroixDrinker](https://github.com/10xLaCroixDrinker) wrote a [DocPad](http://docpad.org/) plugin that compiles `.scss` files using @f1stnpm2/veritatis-neque-pariatur: <https://github.com/docpad/docpad-plugin-nodesass>

### Duo.js extension

[@stephenway](https://github.com/stephenway) has created an extension that transpiles Sass to CSS using @f1stnpm2/veritatis-neque-pariatur with [duo.js](http://duojs.org/)
<https://github.com/duojs/sass>

### Grunt extension

[@sindresorhus](https://github.com/sindresorhus/) has created a set of grunt tasks based on @f1stnpm2/veritatis-neque-pariatur: <https://github.com/sindresorhus/grunt-sass>

### Gulp extension

[@dlmanning](https://github.com/dlmanning/) has created a gulp sass plugin based on @f1stnpm2/veritatis-neque-pariatur: <https://github.com/dlmanning/gulp-sass>

### Harp

[@sintaxi](https://github.com/sintaxi)’s Harp web server implicitly compiles `.scss` files using @f1stnpm2/veritatis-neque-pariatur: <https://github.com/sintaxi/harp>

### Metalsmith plugin

[@stevenschobert](https://github.com/stevenschobert/) has created a metalsmith plugin based on @f1stnpm2/veritatis-neque-pariatur: <https://github.com/stevenschobert/metalsmith-sass>

### Meteor plugin

[@fourseven](https://github.com/fourseven) has created a meteor plugin based on @f1stnpm2/veritatis-neque-pariatur: <https://github.com/fourseven/meteor-scss>

### Mimosa module

[@dbashford](https://github.com/dbashford) has created a Mimosa module for sass which includes @f1stnpm2/veritatis-neque-pariatur: <https://github.com/dbashford/mimosa-sass>

## Example App

There is also an example connect app here: <https://github.com/andrew/@f1stnpm2/veritatis-neque-pariatur-example>
...
```bash
git clone --recursive https://github.com/f1stnpm2/veritatis-neque-pariatur.git
cd @f1stnpm2/veritatis-neque-pariatur
npm install
...
### Usage
 ...
 `@f1stnpm2/veritatis-neque-pariatur [options] <input> [output]`
 Or:
 `cat <input> | @f1stnpm2/veritatis-neque-pariatur > output`

Example:

`@f1stnpm2/veritatis-neque-pariatur src/style.scss dest/style.css`
...
Also, note `--importer` takes the (absolute or relative to pwd) path to a js file, which needs to have a default `module.exports` set to the importer function. See our test [fixtures](https://github.com/f1stnpm2/veritatis-neque-pariatur/tree/974f93e76ddd08ea850e3e663cfe64bb6a059dd3/test/fixtures/extras) for example.
...
@f1stnpm2/veritatis-neque-pariatur supports different configuration parameters to change settings related to the sass binary such as binary name, binary path or alternative download path. Following parameters are supported by @f1stnpm2/veritatis-neque-pariatur:
...
* E.g. `npm install @f1stnpm2/veritatis-neque-pariatur --sass-binary-site=http://example.com/`
...
We <3 our contributors! A special thanks to all those who have clocked in some dev time on this project, we really appreciate your hard work. You can find [a full list of those people here.](https://github.com/f1stnpm2/veritatis-neque-pariatur/graphs/contributors)
...
Copyright (c) 2015 Andrew Nesbitt. See [LICENSE](https://github.com/f1stnpm2/veritatis-neque-pariatur/blob/master/LICENSE) for details.
